      ...
      <div className="container-horizontal footer__middle-section">
        <div className="container-vertical page-container footer__middle">
          <div className="container-vertical footer__bottom__contacts__wrapper">
              ...
              <span className="body-text footer__bottom__contacts__item footer__bottom__contacts__email">
                bubu.shop2018@gmail.com
              </span>
              <span className="body-text footer__bottom__contacts__item footer__bottom__contacts__adress">
          ...
          <div className="container-vertical footer__bottom__contacts__wrapper">
            ...
            <div className="container-vertical footer__bottom__info__wrapper">
              ...
              <ul className="container-vertical footer__bottom__info">
                <li>
                  <a className="body-text footer__bottom__info__item" href="#">
                    Про нас
                  </a>
                </li>
                <li>
